...
public class StudentHistoryAdapter extends BaseExpandableListAdapter {
    ...
    public int getChildrenCount(int groupPosition) {
        return SemesterTranscriptModels.get(groupPosition).getSectionTranscriptModelList().size();
    }
    ...
    public Object getChild(int groupPosition, int childPosition) {
        return SemesterTranscriptModels.get(groupPosition).getSectionTranscriptModelList().get(childPosition);
    }
